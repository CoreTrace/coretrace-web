...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('ctrace.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('ctrace.wasm', import.meta.url).href;
}
...
var _contains_main = Module['_contains_main'] = createExportWrapper('contains_main', 1);
